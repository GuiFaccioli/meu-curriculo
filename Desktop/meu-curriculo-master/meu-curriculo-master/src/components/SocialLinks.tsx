...
export function SocialLinks({ links }: SocialLinksProps) {
  ...
  const emailLink = links.find((link) => link.label === 'E-mail')
  ...
  return (
    <nav className="hero-links" aria-label="Links profissionais">
      <div className="hero-links-row">
        {githubLink ? (
          <a
            ...
            target={githubLink.href.startsWith('http') ? '_blank' : undefined}
            rel={githubLink.href.startsWith('http') ? 'noreferrer' : undefined}
          >
            <SocialIcon label={githubLink.label} />
        ...
        {linkedinLink ? (
          <a
            ...
            target={linkedinLink.href.startsWith('http') ? '_blank' : undefined}
            rel={linkedinLink.href.startsWith('http') ? 'noreferrer' : undefined}
          >
            <SocialIcon label={linkedinLink.label} />
      ...
      {emailLink ? (
        <span className="hero-email" role="text">
